...
class DetailPage4 extends StatefulWidget {
  ...
  @override
  State<DetailPage4> createState() => _DetailPageState();
}

class _DetailPageState extends State<DetailPage4> {
  int gottenStars = 4;
  int selectedIndex = -1;
  @override
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    image: DecorationImage(
                        image: AssetImage("img/Wadi_Qannoubine.png"),
                        fit: BoxFit.cover),
                  ),
                )),
            //Positioned(
                  ...
                  child: Column(
                    ...
                    children: [
                      Row(
                        ...
                        children: [
                          AppLargeText(
                              text: "Wadi Qannoubine", color: Colors.black.withOpacity(0.8)),
                      ...
                      SizedBox(height: 8),
                      AppText(
                        text: "n the heart of Bcharre in northern Lebanon,"
                            " discover Wadi Qannoubine, a beautiful valley filled"
                            " with secret spots that will take your breath away.",
